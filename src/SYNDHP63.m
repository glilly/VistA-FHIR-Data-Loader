...
LABADD(RETSTA,DHPPAT,DHPLOC,DHPTEST,DHPRSLT,DHPRSDT,DHPLOINC,DHPCSAMP) ;Create lab test
 ...
 ; Omit empty CSAMP so ISIIMPU7 uses the test's #60.03 default.
 ; Passing BLOOD makes ISI rewrite it to RED TOP, which FOIA/fhirprod #62 lacks.
 I DHPCSAMP'="" S LABARRAY("COLLECTION_SAMPLE")=DHPCSAMP
